...
#define AsyncList_ForEach(current, list, type) AsyncList_ResetIterator((list)->BaseList->DefaultIterator); while ((current) = (type)AsyncList_Iterate((list)->BaseList->DefaultIterator))
